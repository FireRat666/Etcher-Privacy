const translation = {
	translation: {
		...
		completed: '完毕',
		yesExit: '是的，可以退出',
		reallyExit: '真的要现在退出 Etcher Privacy 吗？',
		yesContinue: '是的，继续',
		progress: {
			starting: '正在启动……',
			decompressing: '正在解压……',
		...
		message: {
			...
			exitWhileFlashing:
				'您当前正在刷机。 关闭 Etcher Privacy 可能会导致您的磁盘无法使用。',
			...
			validation:
				'写入已成功完成，但 Etcher Privacy 在从磁盘读取镜像时检测到潜在的损坏问题。 \n\n请考虑将镜像写入其他磁盘。',
			openError: '打开 {{source}} 时出错。\n\n错误信息： {{error}}',
			flashError: '烧录 {{image}} {{targets}} 失败。',
			unplug:
				'看起来 Etcher Privacy 失去了对磁盘的连接。 它是不是被意外拔掉了？\n\n有时这个错误是因为读卡器出了故障。',
			cannotWrite:
				'看起来 Etcher Privacy 无法写入磁盘的这个位置。 此错误通常是由故障的磁盘、读取器或端口引起的。 \n\n请使用其他磁盘、读卡器或端口重试。',
			childWriterDied:
				'写入进程意外崩溃。请再试一次，如果问题仍然存在，请联系 Etcher Privacy 团队。',
		...
		menu: {
			...
			goback: '回去',
			goforward: '前进',
			about: '关于 Etcher Privacy',
			hide: '隐藏 Etcher Privacy',
			hideOthers: '隐藏其它窗口',
			unhide: '取消隐藏',
			quit: '退出 Etcher Privacy',
		},
		source: {
		...
		drives: {
			...
			openInBrowser: 'Etcher Privacy 会在浏览器中打开 {{link}}',
			changeTarget: '改变目标',
